...
async function addComment(owner, repository, id, body) {
    try {
        ...
        console.error(`error adding comment to ${owner}/${repository}#${id}: ${e.message}`);
        return null;
    }
}
...
async function addCommentReaction(owner, repository, commentID, reaction) {
    try {
        ...
        console.error(`error adding comment reaction to ${owner}/${repository} comment ${commentID}: ${e.message}`);
        return null;
    }
}
...
async function closeIssue(owner, adapter, id) {
    try {
        ...
        console.error(`error closing issue ${owner}/${adapter}#${id}: ${e.message}`);
        return null;
    }
}
...
async function markNotificationDone(id) {
    ...
    try {
        ...
        console.error(`error marking notification thread ${id} as done`);
        throw e;
    }
}
